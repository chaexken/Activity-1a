...
public class MainActivity extends AppCompatActivity {
    ...
    Button button_red, button_green, button_blue, button_reset, button_yellow, button_violet;
        ...
        button_yellow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (button_yellow.getText().equals("Yellow")) {
                    ...
                    Toast.makeText(MainActivity.this, "You have successfully changed the color to yellow!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        button_violet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (button_violet.getText().equals("Violet")) {
                    ...
                    Toast.makeText(MainActivity.this, "You have successfully changed the color to violet!", Toast.LENGTH_SHORT).show();
                }
            }
        });
